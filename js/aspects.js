...
// Parse the Data
d3.csv("beanScores.csv").then( function(data) {

    //data = data.filter(function(d) {
    //return d.Grading_Year === 2015;
  ...
  dimensions = ["Aroma", "Flavor", "Aftertaste", "Acidity", "Body", "Balance", "CupperPoints" ]
  ...
  for (i in dimensions) {
    ...
    y[name] = d3.scaleLinear()
      .domain( [6,9] ) // --> Same axis range for each group
      //.domain([0,8])
